...
|---|---|---|---|
| `prometheus` | `prom/prometheus:v2.52.0` | control (master1) | TSDB + scrape engine |
| `node-exporter` | `prom/node-exporter:v1.8.1` | control (master1) | OS metrics |
| `node-exporter-compute` | `prom/node-exporter:v1.8.1` | compute (master2) | OS metrics |
| `cadvisor` | `gcr.io/cadvisor/cadvisor:v0.49.1` | control (master1) | Container metrics |
| `cadvisor-compute` | `gcr.io/cadvisor/cadvisor:v0.49.1` | compute (master2) | Container metrics |
