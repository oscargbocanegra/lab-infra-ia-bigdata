...
| Date | Change |
|------|--------|
| 2026-07-18 | Residual CI warning closed: upgraded `actions/setup-python` to `@v6` and `jupyterhub-deploy` Docker login action to `@v4` for full Node 24 compatibility. |
